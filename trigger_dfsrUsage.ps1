...
If ($rawQueueInt -gt $alarmThreshold) {
    ...
    Send-MailMessage -from "noreply@sgadvisors.com" -to "notify@domain.com", "notify2@self.com" -subject "DFS Queue Warning: No user action required" -body "Backlog Queue Threshold of $alarmThreshold exceeded." -SmtpServer 192.168.20.10;
    }
